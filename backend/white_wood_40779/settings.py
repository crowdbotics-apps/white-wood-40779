"""
Django settings for white_wood_40779 project.
...
ROOT_URLCONF = 'white_wood_40779.urls'
...
WSGI_APPLICATION = 'white_wood_40779.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "white_wood_40779 API",
    "DESCRIPTION": "API documentation for white_wood_40779 App",
    "VERSION": "v1",
}
